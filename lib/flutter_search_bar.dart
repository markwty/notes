...
class SearchBar {
  ...
  AppBar buildSearchBar(BuildContext context) {
    ...
    Color buttonColor = inBar ? null : (btnColor == null? theme.iconTheme.color: btnColor);
    ...
    return AppBar(
      ...
      backgroundColor: inBar ? null : (barColor == null? theme.canvasColor: barColor),
      title: Directionality(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: inBar
                ? null
                : TextStyle(color: theme.textTheme.headline4.color),
